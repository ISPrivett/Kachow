(function() {
    ...
    const defaultImageUrl = 'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/d3789c8c-0874-407c-a457-03b147f59b18/dfat773-401506bb-96ce-494f-a767-34f356198220.png/v1/fit/w_720,h_435/lighting_mcqueen_transparent_by_darkmoonanimation_dfat773-375w-2x.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Ud8I-aUo8WMOPx1c_SkzHPNB-dSdHvWbOTZnVsrmIS0';
    const defaultQuery = 'lightning';

    chrome.storage.sync.get(['soundUrl', 'imageUrl', 'query'], (result) => {
        const sound = new Audio(result.soundUrl || defaultSoundUrl);
        sound.preload = 'auto';
        ...
        const addImage = () => {
            ...
            image.src = result.imageUrl || defaultImageUrl;
        ...
        textInputs.forEach(input => {
            input.addEventListener('input', () => {
                ...
                debounceTimer = setTimeout(() => {
                    ...
                    if (levenshteinDistance(query, result.query || defaultQuery) <= threshold) {
                        addImage();
                    } else {
                        removeImage();
                    }
